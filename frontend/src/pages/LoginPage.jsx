  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3 z-10">
        ...
        <h2 className="text-3xl font-extrabold tracking-tight text-white">NutriPulse</h2>
        <p className="text-sm text-slate-400">Personalized Calorie & Nutrition Recommendation Engine</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md z-10 px-4">
        <div className="glass-panel p-8 rounded-2xl border border-slate-800 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleLoginSubmit} className="space-y-4">
            ...
            >
              {loading ? "Signing in..." : "Sign In to NutriPulse"} <ArrowRight className="w-4 h-4" />
            </button>
          </form>
